...
namespace System.Windows.Controls
{
    ...
    public class TreeViewEx : ItemsControl
    {
        ...
        public static readonly DependencyProperty DropManagerProperty = DependencyProperty.Register(
            "DropManager", typeof(IDropManager), typeof(TreeViewEx), new PropertyMetadata(null));

        public static readonly DependencyProperty DragManagerProperty = DependencyProperty.Register(
            "DragManager", typeof(IDragManager), typeof(TreeViewEx), new PropertyMetadata(null));
        ...
        public IDropManager DropManager
        {
            get
            {
                return (IDropManager)GetValue(DropManagerProperty);
            }

            set
            {
                SetValue(DropManagerProperty, value);
            }
        }
        ...
        public IDragManager DragManager
        {
            get
            {
                return (IDragManager)GetValue(DragManagerProperty);
            }

            set
            {
                SetValue(DragManagerProperty, value);
            }
        }
        ...
        private void OnSelectedItemsChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                ...
                case NotifyCollectionChangedAction.Reset:
                    var treeViewExItems = TreeViewElementFinder.FindAll(this, false);
                    foreach (var item in treeViewExItems)
                    {
                        if (item.IsSelected)
                        {
                            item.IsSelected = false;
